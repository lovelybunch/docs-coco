...
Pages are the unit of content. These routes read and write them, walk their revision history, and reach their metadata and links.
...
| `GET /pages/:space/:path/links` | Outbound links and backlinks |
