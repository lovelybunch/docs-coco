...
The whole view state lives in the URL, so a tuned view is shareable as a link and bookmarkable as a team dashboard. One example: _"diligence-stage deals with conviction at or above 0.7, least recently reviewed first."_
