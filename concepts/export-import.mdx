---
title: "Export & import"
description: "Portable space bundles for moving between deployments, sharing, and snapshots"
icon: "arrows-up-down"
---
...
- `overwrite` writes new revisions (nothing is ever destroyed, since revisions are append-only).
...
- Moving a solution between deployments, such as dev to prod
- Sharing a template kit
- Seeding a new customer's space
